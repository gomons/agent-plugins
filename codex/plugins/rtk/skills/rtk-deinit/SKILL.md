...
3. Confirm the result:
   ...
   `test ! -f "$HOME/.codex/AGENTS.md" || ! grep -Fq 'RTK.md' "$HOME/.codex/AGENTS.md"`
...
- The plugin validates deinit by checking that `~/.codex/RTK.md` is gone and that `~/.codex/AGENTS.md` no longer contains an `RTK.md` reference.
