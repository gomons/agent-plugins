...
3. Confirm the result:
   ...
   `grep -n "@RTK.md" "$HOME/.codex/AGENTS.md"`
...
- The install path tries multiple known init flag shapes, then validates that RTK created `~/.codex/RTK.md` and that `~/.codex/AGENTS.md` references `@RTK.md`. It does not rewrite `AGENTS.md`.
